...
const drugDatabase = [
  "Lisinopril", "Metformin", "Atorvastatin", "Amlodipine", "Levothyroxine", "Amoxicillin",
  "Azithromycin", "Hydrochlorothiazide", "Ibuprofen", "Acetaminophen", "Simvastatin"
];
...
export default function WritePrescriptionView() {
              ...
              <CardHeader>
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <CardDescription>Fill in the medication details for {selectedPatient?.name}.</CardDescription>
                    </div>
                    <Button variant="link" onClick={() => { setStep(1); setSelectedPatient(null); }}>Change Patient</Button>
                </div>
              </CardHeader>
              <CardContent>
              ...
              <div className="space-y-4 text-sm p-4 border rounded-md bg-white">
                ...
                <div className="flex justify-between">
                    <div>
                        ...
                        <p className="text-gray-600">Age: {selectedPatient?.age}, Gender: {selectedPatient?.gender}</p>
                    </div>
  ...
  return (
    <div className="h-full">
      {step === 1 ? <PatientSelectionStep /> : <PrescriptionFormStep />}
    </div>
  );
}
